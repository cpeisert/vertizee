...
from vertizee.algorithms.search.depth_first_search import (
    depth_first_search, dfs_preorder_traversal, dfs_postorder_traversal,
...
from vertizee.algorithms.shortest_paths.weighted import (
    shortest_paths_bellman_ford, shortest_paths_dijkstra)
from vertizee.algorithms.tree.spanning import (
    spanning_tree_kruskal, spanning_tree_prim, spanning_tree_prim_fibonacci)
