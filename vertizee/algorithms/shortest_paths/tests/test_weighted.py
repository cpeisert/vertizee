...
from vertizee.algorithms.shortest_paths.weighted import \
    ...
    all_pairs_shortest_paths_johnson, all_pairs_shortest_paths_johnson_fibonacci, \
    shortest_paths_bellman_ford, \
    shortest_paths_dijkstra, shortest_paths_dijkstra_fibonacci
...
class TestWeightedAllPairsShortestPaths:
    ...
    def test_floyd_warshall_find_path_lengths_only(self):
        ...
        paths: VertexDict[VertexDict[ShortestPath]] = \
            all_pairs_shortest_paths_floyd_warshall(g, find_path_lengths_only=True)
...
class TestWeightedSingleSourceShortestPaths:
    ...
    def test_dijkstra_path_reconstruction(self):
        ...
        assert paths['x'].path == ['s', 'y', 't', 'x'], \
            'Path s ~> x should be [s, y, t, x].'
