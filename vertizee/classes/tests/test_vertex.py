...
class TestVertexModuleFunctions:
    ...
    def test_is_vertex_type(self):
        ...
        assert (
            vertex_module.is_vertex_type(("s", {"color": "blue"}))
        ), "vertex tuple should be a VertexType"
        assert not vertex_module.is_vertex_type(10.99), "float should not be a VertexType"
        assert (
            not vertex_module.is_vertex_type(("s", "t"))
        ), "edge tuple should not be a VertexType"
        assert (
            not vertex_module.is_vertex_type(("s", "t", 4.5))
        ), "edge tuple with edge weight should not be a VertexType"
        g.add_edge("s", "t")
        assert (
            not vertex_module.is_vertex_type(g["s", "t"])
...
class TestVertexBase:
    ...
    def test_is_isolated(self):
        ...
        assert v1.is_isolated(), "vertex with self loop should be considered isolated"
...
class TestVertex:
    ...
    def test_issubclass_and_isinstance(self):
        ...
        v1 = g.add_vertex(1)
        assert (
            isinstance(v1, vertex_module.VertexBase)
...
class TestDiVertex:
    ...
    def test_issubclass_and_isinstance(self):
        ...
        assert (
            issubclass(DiVertex, vertex_module.VertexBase)
...
class TestMultiVertex:
    ...
    def test_issubclass_and_isinstance(self):
        ...
        assert (
            issubclass(MultiVertex, vertex_module.VertexBase)
...
class TestMultiDiVertex:
    ...
    def test_issubclass_and_isinstance(self):
        ...
        assert (
            issubclass(MultiDiVertex, vertex_module.VertexBase)
